...
Micro:bit har et innebygd magnetometer (en elektronisk kompass-brikke) som måler styrken og retningen på magnetiske felt i tre dimensjoner. Ved å kalibrere sensoren kan vi bruke den til å måle magnetiske retninger i felt.
...
*   Gjør deg kjent med hvordan du overfører programvare til micro:bit ved å dra en nedlastet `.hex`-fil over til micro:bit-stasjonen på PC-en din.
