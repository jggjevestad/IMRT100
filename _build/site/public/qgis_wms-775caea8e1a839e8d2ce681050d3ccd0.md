...
:alt: Dialogvindu for å opprette en ny WMS/WMTS-tilkobling
Fyll inn navn og URL for WMS-tjenesten i dialogvinduet.
```
...
:alt: Datakildebehandler med WMS-lagliste
Etter tilkobling vises tilgjengelige lag i en trestruktur. Velg ønsket lag og trykk **Legg til**.
```
