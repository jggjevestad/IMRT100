...
<div class="geo-dashboard">
  ...
  <div class="geo-dashboard-item">
    ...
    <span class="geo-dashboard-value">Mobilkamera / Scanner, <a href="../bruksanvisninger/qgis_intro.md">QGIS</a></span>
  </div>
  <div class="geo-dashboard-item">
...
## 🎯 Introduksjon
Før satellitter og luftfoto digitaliserte kartfaget, ble kart tegnet for hånd basert på manuelle målinger i felt. Denne oppgaven vil trene opp ditt romlige blikk og gi deg en dypere forståelse av målestokk, kartprojeksjoner, kompassretninger og passpunkter.
