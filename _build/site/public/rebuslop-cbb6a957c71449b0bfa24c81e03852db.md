...
Kartkoordinater blir ofte gitt i meter (Nord og Øst) når jordkloden er projisert (flatklemmet). Det vanligste kartsystemet i Norge er EUREF89 UTM sone 32. Finn frem til følgende UTM-koordinater:
...
:::{important} Viktig
Svar på de ti rebusspørsmålene over i grupperapporten din, og legg ved selfiene dere tok på postene for å dokumentere at dere har funnet stedene. Svar også på følgende refleksjonsspørsmål:
:::
